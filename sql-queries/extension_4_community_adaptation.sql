-- Community Adaptation and Resilience Metrics for Southern Africa
-- Focus on vulnerability and adaptation capacity indicators

SELECT 
  year,
  month,
  precipitation,
  -- Community vulnerability index (based on drought conditions)
  CASE 
