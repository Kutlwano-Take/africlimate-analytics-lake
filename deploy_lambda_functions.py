#!/usr/bin/env python3
"""
AfriClimate Analytics Lake - Lambda Deployment Script
Deploys all 5 creative extensions as AWS Lambda functions
"""
...
def main():
    ...
    print("🌍 AfriClimate Analytics Lake - Lambda Deployment")
    print("=" * 50)
    ...
    lambda_functions = [
        {
            ...
            'env_vars': {
                'SNS_TOPIC_ARN': f'arn:aws:sns:{AWS_REGION}:{boto3.client("sts").get_caller_identity()["Account"]}:africlimate-drought-alerts',
